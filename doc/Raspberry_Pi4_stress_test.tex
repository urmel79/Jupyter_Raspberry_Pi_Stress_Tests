...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Raspberry_Pi4_stress_test_files/Raspberry_Pi4_stress_test_33_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
This is the plot of the temperature curve compared with the CPU
frequency curve for the Raspberry Pi B4 with the cooling variant
``glued-on heat sinks with fan (driven by 3.3 V)''.
...
\PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{RaspiB4JupyterLab: active cooling (glued\PYZhy{}on heat sinks with fan, 3.3 V)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{n}{line1} \PY{o}{=} \PY{n}{ax1}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{df\PYZus{}4\PYZus{}PC\PYZus{}wHeatSinksAndFan3V}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Time}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{df\PYZus{}4\PYZus{}PC\PYZus{}wHeatSinksAndFan3V}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CPU Temperature}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{navy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CPU Temperature}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{c+c1}{\PYZsh{}plt.plot(df\PYZus{}4\PYZus{}PC\PYZus{}wHeatSinksAndFan3V[\PYZsq{}Time\PYZsq{}], df\PYZus{}4\PYZus{}PC\PYZus{}wHeatSinksAndFan3V[\PYZsq{}CPU Temperature\PYZsq{}], \PYZsq{}\PYZhy{}\PYZsq{}, label=\PYZsq{}R4, Plastic Case with heat sinks and fan (3.3 V), AVG\PYZsq{})}
...
\PY{n}{line2} \PY{o}{=} \PY{n}{ax2}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{df\PYZus{}4\PYZus{}PC\PYZus{}wHeatSinksAndFan3V}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Time}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{df\PYZus{}4\PYZus{}PC\PYZus{}wHeatSinksAndFan3V}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CPU Frequency}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{limegreen}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CPU Frequency}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
